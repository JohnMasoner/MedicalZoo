...
class MonoMedDataSets2D(torch.utils.data.Dataset):
    ...
    '''
    def __init__(self, file_dir, transform = None, file_mode = None,data_type=None) -> None:
        '''
        Args:
...
if __name__ == '__main__':
    data = MonoMedDataSets2DTest('/raid0/myk/Y064/Dataset', file_mode = 'NPY_train',data_type='CT')
